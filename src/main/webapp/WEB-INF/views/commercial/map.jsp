		...
		<form name="hotPlaceForm">
			...
			<div class="check-area">
				<div class="nav nav-pills btn-group d-flex justify-content-center" id="v-pills-tab" role="tablist">
				    ...
				    <input class="nav-link" id="output" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="radio" role="tab" aria-controls="v-pills-profile" aria-selected="false" name="selectMenu">
