			...
			<div class="check-area">
				...
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
						...
						<div class="d-flex justify-content-center">
							<select name="#" class="form-select selectWork" style="margin-top: 5px;">
					...
					<div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab" tabindex="0">
					    <div class="select-title">성별</div>
						<div class="btn-group three-btn-group" role="group4" aria-label="Basic radio toggle button group" style=" margin-left: 16px; width: 92%;">
						...
						<div class="select-title">연령대</div>
					    <div class="btn-group five-btn-group" role="group5" aria-label="Basic radio toggle button group" style=" margin-left: 16px; width: 92%;">
