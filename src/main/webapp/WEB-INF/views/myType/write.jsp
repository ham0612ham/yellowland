...
function sendOk() {
	const f = document.myTypeCommForm;
	let str;
	...
	f.action = "${pageContext.request.contextPath}/myType/${mode}";
	f.submit();
}
</script>
...
$(function(){
	$("form select[name=catejobNum]").change(function(){
		...
		let url = "${pageContext.request.contextPath}/myType/listJob";
...
function deleteFile(fileNum) {
	let url = "${pageContext.request.contextPath}/myType/deleteFile";
...
<div class="container">
	<div class="body-container">	
		...
		<form name="myTypeCommForm" method="post" enctype="multipart/form-data">	
			<table class="table">
				<thead>
					<tr>
				...
				<tr>
					<td class="text-center">
						...
						<button type="button" class="btn btn-light"
								onclick="location.href='${pageContext.request.contextPath}/myType/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i
									class="bi bi-x"></i>
						</button>
