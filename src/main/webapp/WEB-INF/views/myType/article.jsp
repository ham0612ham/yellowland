...
function deleteOk(num) {
    if(confirm("글을 삭제 하시겠습니까 ? ")) {
	    ...
	    let url = "${pageContext.request.contextPath}/myType/delete?" + query;
    	location.href = url;
    }
}
</c:if>
...
function listPage(page) {
	let url = "${pageContext.request.contextPath}/myType/listReply";
...
$(function(){
	$(".btnSendReply").click(function(){
		...
		let url = "${pageContext.request.contextPath}/myType/insertReply";
...
$(function(){
	$("body").on("click", ".deleteReply", function(){
		...
		let url = "${pageContext.request.contextPath}/myType/deleteReply";
...
$(function(){
	$(".btnSendTypeLike").click(function(){
		...
		let url = "${pageContext.request.contextPath}/myType/insertTypeCommLike";
		let num = "${dto.num}";
		...
		<div class="body-main">
					...
					<tr>
						<td colspan="2" >
							...
							<c:if test="${not empty preReadDto}">
								<a href="${pageContext.request.contextPath}/myType/article?${query}&num=${preReadDto.num}" style="text-decoration: none; color:black;">${preReadDto.subject}</a>
							</c:if>
						</td>
					</tr>
					<tr>
						<td colspan="2" style="text-decoration: none;">
							...
							<c:if test="${not empty nextReadDto}">
								<a href="${pageContext.request.contextPath}/myType/article?${query}&num=${nextReadDto.num}" style="text-decoration: none; color:black;">${nextReadDto.subject}</a>
							</c:if>
						</td>
					</tr>
				</tbody>
			...
			<table class="table table-borderless">
				<tr>
					<td width="50%">
						<c:choose>
							<c:when test="${sessionScope.member.userId==dto.userId}">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/myType/update?num=${dto.num}&page=${page}&size=${size}';">수정</button>
							</c:when>
					...
					<td class="text-end">
						<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/myType/list?${query}';">목록</button>
					</td>
				</tr>
			</table>
