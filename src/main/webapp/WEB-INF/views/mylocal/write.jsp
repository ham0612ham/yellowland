...
function sendOk() {
	...
	f.action = "${pageContext.request.contextPath}/mylocal/${mode}";
	f.submit();
}
</script>
...
$(function(){
	$("form select[name=siguNum]").change(function(){
		...
		let url = "${pageContext.request.contextPath}/mylocal/listDong";
...
<div class="container">
	<div class="body-container">	
		<h3 class="fw-semibold">지역별 커뮤니티  내 글 작성</h3>
		<hr>

		<form name="mylocalForm" method="post" enctype="multipart/form-data">	
			<table class="table">
				<thead>
					<tr>
				...
				<tr>
					<td class="text-center">
						...
						<button type="button" class="btn btn-light"
								onclick="location.href='${pageContext.request.contextPath}/mylocal/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i
									class="bi bi-x"></i>
						</button>
