...
$(function(){
	   ...
	   $("ul.tabs li").click(function() {
	      ...
	      let url = "${pageContext.request.contextPath}/myType/list";   
	      location.href = url;
	   });
	});
function searchList() {
	...
	<div class="body-container">
		<div class="table2">
			...
			<div class="page-navigation">
				...
				<button class="btnDelete btn btn-light" style="float: left; width: 90px; border-radius: 8px; border: 0.5px solid #A3A6AD; color: #A3A6AD;" onclick="location.href='${pageContext.request.contextPath}/mylocal/list';">
					새로고침
				</button>
				<form class="d-flex justify-content-between" name="searchForm"
					class="d-flex justify-content-between"
					action="${pageContext.request.contextPath}/mylocal/list"
					method="post">
					<div>
