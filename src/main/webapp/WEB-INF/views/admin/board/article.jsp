...
function deleteOk(num) {
    if(confirm("글을 삭제 하시겠습니까 ? ")) {
	    ...
	    let url = "${pageContext.request.contextPath}/admin/board/delete?" + query;
    	location.href = url;
    }
}
</c:if>
...
function listPage(page) {
	let url = "${pageContext.request.contextPath}/admin/board/listReply";
...
$(function(){
	$(".btnSendReply").click(function(){
		...
		let url = "${pageContext.request.contextPath}/admin/board/insertReply";
...
$(function(){
	$("body").on("click", ".deleteReply", function(){
		...
		let url = "${pageContext.request.contextPath}/admin/board/deleteReply";
...
$(function(){
	$(".btnSendLocalLike").click(function(){
		...
		let url = "${pageContext.request.contextPath}/admin/board/insertBoardLike";
		let num = "${dto.num}";
		...
		<div class="body-main">
					...
					<tr>
						<td colspan="2" >
							...
							<c:if test="${not empty preReadDto}">
								<a href="${pageContext.request.contextPath}/admin/board/article?${query}&num=${preReadDto.num}" style="text-decoration: none; color:black;">${preReadDto.subject}</a>
							</c:if>
						</td>
					</tr>
					<tr>
						<td colspan="2" style="text-decoration: none;">
							...
							<c:if test="${not empty nextReadDto}">
								<a href="${pageContext.request.contextPath}/admin/board/article?${query}&num=${nextReadDto.num}" style="text-decoration: none; color:black;">${nextReadDto.subject}</a>
							</c:if>
						</td>
					</tr>
				</tbody>
			...
			<table class="table table-borderless">
				<tr>
					...
					<td class="text-end">
						<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/board/list?${query}';">목록</button>
					</td>
				</tr>
			</table>
