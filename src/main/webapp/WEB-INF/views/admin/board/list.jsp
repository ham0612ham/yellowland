...
$(function(){
	   ...
	   $("ul.tabs li").click(function() {
	      ...
	      let url = "${pageContext.request.contextPath}/admin/type/list";   
	      location.href = url;
	   });
	});
...
<div class="container">
   <div class="table1">
      ...
      <div class="row row-cols-auto">
         ...
         <div class="col"><a href="/app/admin/noticeManage/list" class="text-decoration-none" style="color:#C2C2C2">공지사항 관리</a></div>
         <div class="col"><a href="/app/admin/faqManage/list" class="text-decoration-none" style="color:#C2C2C2">자주 하는 질문 관리</a></div>
         <div class="col"><a href="/app/admin/qnaManage/list" class="text-decoration-none" style="color:#C2C2C2">1:1문의 관리</a></div>
         ...
         <div class="col"><a href="/app/admin/memberManage/list" class="text-decoration-none" style="color:#C2C2C2">회원 관리</a></div>
         
      </div>
   </div>
   <div class="body-container">
      <div class="table2">
         <h3 class="title1">게시글관리</h3>
         <div class="body-main">
      ...
      <form name="listForm" method="post">      
         <table class="table note-table">
            <thead>
               <tr> 
                  ...
                  <th class="wx-120">지역</th>
                  <th class="wx-120">세부지역</th>
               ...
               <c:forEach var="dto" items="${list}" varStatus="status">
                  <tr>                  
                     ...
                     <td>${dto.userName}</td>
                     <td>${dto.siguName}</td>
                    <td style=" max-width: 70px; text-overflow: ellipsis; white-space: nowrap; overflow:hidden;">${dto.dongName}</td>
                     <td>${dto.regDate}</td>
                  </tr>
                  </c:forEach>
            <tbody>
         ...
         <div class="page-navigation">
           ...
           <div class="board-list-footer d-flex justify-content-between" style="margin-top: 30px;">
				<button class="btnDelete btn btn-light" style="float: left; width: 90px; border-radius: 8px; border: 0.5px solid #A3A6AD; color: #A3A6AD;" onclick="location.href='${pageContext.request.contextPath}/admin/board/list';">
					새로고침
				</button>
				<form class="d-flex justify-content-between" name="searchForm"
					class="d-flex justify-content-between"
					action="${pageContext.request.contextPath}/admin/board/list" method="post">
					<div>
