...
<div class="container">
	<div class="body-container">	
		<h3 class="fw-semibold" style="color: #36C88A;">자주하는질문관리</h3>
		<br>
		...
		<table class="table table-borderless">
			<tr>
				<td class="text-center">
					...
					<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/faqManage/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button> 
