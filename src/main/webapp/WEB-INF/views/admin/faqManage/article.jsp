...
<c:if test="${sessionScope.member.membership>50}">
	function deleteOk() {
	    if(confirm("게시글을 삭제 하시 겠습니까 ? ")) {
		    ...
		    let url = "${pageContext.request.contextPath}/admin/faqManage/delete?" + query;
	    	location.href = url;
	    }
	}
</c:if>
...
<div class="container">
	<div class="body-container">	
		<div class="articleSubject">
			<h3 class="categoryTitle">자주하는질문</h3>
		...
		<div class="articleLower">
			...
			<h5 class="preNext" style="color: #696969; font-size: 16px;">
				...
				<c:if test="${not empty preReadDto}">
					<a href="${pageContext.request.contextPath}/admin/faqManage/article?${query}&num=${preReadDto.num}" style=" text-decoration: none; color:black;">${preReadDto.subject}</a>
				</c:if>
			</h5>
			<hr class="division">
			<h5 class="preNext" style="color: #696969; font-size: 16px;">
				...
				<c:if test="${not empty nextReadDto}">
					<a href="${pageContext.request.contextPath}/admin/faqManage/article?${query}&num=${nextReadDto.num}" style=" text-decoration: none; color:black;">${nextReadDto.subject}</a>
				</c:if>	
			</h5>
			<hr class="division">
		</div>
	 	...
	 	<table class="table ">
				...
				<tr>
					<td align="left" width="50%" style="    padding-left: 0px;">
							<button type="button" class="btn btn-primary btnReplyNote" onclick="location.href='${pageContext.request.contextPath}/admin/faqManage/update?num=${dto.num}&page=${page}';">수정</button>			
					...
					<td align="right" width="50%" style="    padding-left: 0px;">
							<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/faqManage/list?${query}';">목록</button>
					</td>
				</tr>
			</table>
	 </div>
