...
function sendOk() {
    ...
    f.action = "${pageContext.request.contextPath}/myqna/${mode}";
    f.submit();
}
...
<div class="container">
	<div class="body-container">	
		...
		<form name="myqnaForm" method="post">
			<table class="table">
				<thead>
					<tr>
						<th scope="col">제목</th>
				...
				<tr>
					<td class="text-center">
						...
						<button type="button" class="btn btn-light"
							onclick="location.href='${pageContext.request.contextPath}/myqna/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i
								class="bi bi-x"></i>
						</button>
