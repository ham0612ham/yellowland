...
function kakaopostIn() {
    new daum.Postcode({
        oncomplete: function(data) {
           document.querySelector("#zip-in").value = data.zonecode;
           document.querySelector("#addr1-in").value =  data.address;
        }
    }).open();
}
...
$(function() {
	...
	$("body").on("click", ".img-insert", function() {
	...
	$("form[name=detailForm] input[name=imgFiles]").change(function(){
		...
		fileArr.forEach((file, index) => {
			...
			const $img = $("<img>", {"class":"item img-item img-in"});
      ...
      <div class="modal-body">
        	<div class="container">
							...
							<div class="row no-gutters">
								<div style="margin-top: -20px;" class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
									<div class="contact-wrap w-100 p-md-5 p-4">
											<div class="row">
									          	...
									          	<div style="margin-top: -25px; display: flex; margin-bottom: 13px;">
										          	<div class="col-md-6">
														<div class="form-group mainImg">
															...
															<input type="file" class="form-control thumbnail" name="thumbnailFile" accept="image/*" 
												...
												<div class="col-md-10">
														<div class="form-group subImg">
															...
															<input type="file" class="form-control imgName" name="imgFiles" accept="image/*" multiple="multiple" 
										...
										<script>
									    	ClassicEditor.create( document.querySelector( '#editorIn' ) );
									    </script>
				...
				<div class="modal-footer">
			        ...
			        <button type="button" onclick="checkIn();" class="btn btn-primary">작성완료</button>
		      	</div>
			</form>
		</div>
      </div>
