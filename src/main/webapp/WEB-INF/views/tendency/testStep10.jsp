...
$(function(){
	$(".choice-tags").click(function(){
		...
		$("input[name=hotplace]").val(val);
		
		const f = document.listForm;
		f.action = "${pageContext.request.contextPath}/tendency/resultEcho";
		f.submit();
	});
});
</script>
...
<div class="container">
	<div class="body-container show">
		...
		<div class="progress-div d-flex justify-content-betwee">
			...
			<span class="circle"></span>
			<span class="circle"></span>
			<span class="circle number-circle">10</span>
		</div>
		<div class="question-div move">
			<div><span class="q-mark">Q. </span><span class="q-disc"> 일하다 잠깐 가게 밖으로 나온 당신, 주위 풍경은?</span></div>
			<div class='choice-div'>
				<div class="choice-border">
					<div class="choice-tags" data-val="hot">
						사람들이 북적북적, 핫하다 핫해! 핫 플레이스 중심의 가게
					</div>
				</div>
				<div class="choice-border">
					<div class="choice-tags" data-val="cold">
						여유로운 가운데, 평화로운 풍경. 한산한 주택가의 가게
					</div>
				</div>
				...
				<form name="listForm" method="post">
					...
					<input type="hidden" name="hotplace" value="">
				</form>
			</div>
		</div>
	</div>
