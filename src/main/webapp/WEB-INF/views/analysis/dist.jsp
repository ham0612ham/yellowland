...
#selectBusinessArea, #selectQuart, #selectYear, #qCondition, #induL, #induM { 
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/dist.js"></script>

<div class="container">
	<div class="body-container">
		<h3 class="fw-semibold">상권별 현황</h3>
		...
		<form name="selectForm" class="d-flex justify-content-start">
			<table class="table table-borderless d-flex justify-content-start" id="select-table">
				...
				<tr class="select-table-body">
					<td>
						<select name="selectBusinessArea" class="form-select" id="selectBusinessArea" style="width: 100px;" title="상권유형 선택">
							<option value="A">골목상권</option>
							<option value="D">발달상권</option>
							<option value="R">전통시장</option>
							<option value="U">관광특구</option>
						</select>
					</td>
					<td>
		...
		<div style="margin-bottom: 10px; text-align: right;" id="excelButton-div">
		</div>
