...
<div class="container">
	<div class="table1">
		...
		<div>
			<div class="colNoticeTitle" style="margin-top: 10px; margin-bottom: 20px;">
				<div>업종별 커뮤니티</div>
			</div>
			
			<div class="col" style="margin-bottom: 15px;">
				<a href="${pageContext.request.contextPath}/localComm/list" class="text-decoration-none" style="color:#C2C2C2; font-size: 20px;">지역별 커뮤니티</a>
			</div>
		</div>
	</div>
